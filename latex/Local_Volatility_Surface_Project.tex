...
\begin{equation}\label{eq:dupire}
    \sigma_{\text{local}}^2(K,T) = \frac{\frac{\partial C}{\partial T} + (r-q)K\frac{\partial C}{\partial K} + qC}{\frac{1}{2}K^2\frac{\partial^2 C}{\partial K^2}}
\end{equation}
...
\begin{align}
    C(K,T) &= S_0 e^{-qT}\Phi(d_1) - Ke^{-rT}\Phi(d_2) \\
...
\STATE Apply Dupire formula: $\sigma_{\text{local}}^2 = \frac{\frac{\partial C}{\partial T} + (r-q)K\frac{\partial C}{\partial K} + qC}{\frac{1}{2}K^2\frac{\partial^2 C}{\partial K^2}}$
...
is available at: \url{https://github.com/francesco-degirolamo/local-vol-surface}
